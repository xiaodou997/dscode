...
| DS Code | Codex CLI | CLI provider | app-server initialize | Desktop schema |
| --- | --- | --- | --- | --- |
| 0.1.0 | 0.146.0 | tested | tested on macOS | stable schema pinned |
...
so packaging and desktop startup can enforce the compatibility policy.
